        ...
        <div className="container mx-auto p-4">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold mb-2">
              <span className="text-gray-900 dark:text-white">Learn Katakana</span>
              <span className="block text-2xl text-purple-500 mt-1">カタカナ を ならう</span>
            </h1>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="relative">
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-8">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4 ml-16">
                  Learn all 46 basic Katakana characters with clear explanations
                  <span className="block text-sm mt-1">
                    46文字のカタカナを分かりやすく学ぶ
                  </span>
                </p>
                <div className="ml-16">
                  <button
                    onClick={() => router.push('/category/katakana/lessons')}
            ...
            <div className="relative">
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-8">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4 ml-16">
                  Practice writing and recognizing Katakana characters
                  <span className="block text-sm mt-1">
                    カタカナの書き方と読み方を練習する
                  </span>
                </p>
                <div className="ml-16">
                  <button
                    onClick={() => router.push('/category/katakana/practice')}
            ...
            <div>
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                ...
                <div className="ml-16">
                  <button
                    onClick={() => router.push('/category/katakana/quiz')}
